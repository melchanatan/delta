...
class RobotTrajectory(object):
    ...
    def move_with_speed(self, speed, motion="p2p", method="linear", object_speed=0.2):
        """
        Move the robot through the trajectory at the specified speed and visualize a moving object.
        :param speed: Speed of the robot's movement (meters/second).
        :param motion: Type of motion ("p2p" or "lin").
        :param method: Interpolation method ("linear" or other).
        :param x_ob1, y_ob1, z_ob1: Initial coordinates of the object.
        :param x_ob2, y_ob2, z_ob2: Final coordinates of the object.
        """
        inter_values, inter_time_points = self.interpolate(num_segs=100, motion=motion, method=method)
        ...
        for i in range(1, len(inter_values)):
            ...
            self.robot.draw()
            self.robot.move_object(i*object_speed)
